...
-   Resolved `ModuleNotFoundError: No module named 'skello'` when installing from PyPI

### Changed

-   Updated build configuration to use `only-include` and `sources` directives for proper src-layout packaging
